...
function Contacto() {
  ...
  function handleSubmit(e) {
    ...
    const reg =/^[a-z0-9]{2,61}\.([a-z0-9]{2,61}|[a-z0-9-]{2,30}\.[a-z]{2,})$/gi
 ...
 return(
  <div className={styles.container}>
    ...
    {error&&
      <div className={styles.error}>ERROR: {msj}</div>}
    {nombre&&
      <div>Gracias <i>{nombre}</i> nos pondremos en contato a la brevedad!</div>}
  </div>
  )
}
